...
public:
    ...
    {
        UserInformation->setWindowTitle(QCoreApplication::translate("UserInformation", "User Information", nullptr));
        qgbConnection->setTitle(QCoreApplication::translate("UserInformation", "Connection Information", nullptr));
        qlCertificate->setText(QString());
        qliOS->setText(QCoreApplication::translate("UserInformation", "OS", nullptr));
        qlVersionNote->setText(QCoreApplication::translate("UserInformation", "Warning: The server seems to report a truncated protocol version for this client. (See: <a href=\"https://github.com/mumble-voip/mumble/issues/5827/\">Issue #5827</a>)", nullptr));
        qliVersion->setText(QCoreApplication::translate("UserInformation", "Version", nullptr));
        qlAddress->setText(QString());
        qlOS->setText(QString());
        qliAddress->setText(QCoreApplication::translate("UserInformation", "IP Address", nullptr));
        qpbCertificate->setText(QCoreApplication::translate("UserInformation", "Details...", nullptr));
        qliCertificate->setText(QCoreApplication::translate("UserInformation", "Certificate", nullptr));
        qlVersion->setText(QString());
        qlOpus->setText(QString());
        qgbPing->setTitle(QCoreApplication::translate("UserInformation", "Ping Statistics", nullptr));
        qliPingCount->setText(QCoreApplication::translate("UserInformation", "Pings received", nullptr));
        qliPingAvg->setText(QCoreApplication::translate("UserInformation", "Average ping", nullptr));
        qliPingVar->setText(QCoreApplication::translate("UserInformation", "Ping deviation", nullptr));
        qliTCP->setText(QCoreApplication::translate("UserInformation", "TCP (Control)", nullptr));
        qlTCPCount->setText(QString());
        qlTCPAvg->setText(QString());
        qlTCPVar->setText(QString());
        qliUDP->setText(QCoreApplication::translate("UserInformation", "UDP (Voice)", nullptr));
        qlUDPCount->setText(QString());
        qlUDPAvg->setText(QString());
        qlUDPVar->setText(QString());
        qgbUDP->setTitle(QCoreApplication::translate("UserInformation", "UDP Network statistics", nullptr));
        qliGood->setText(QCoreApplication::translate("UserInformation", "Good", nullptr));
        qliLate->setText(QCoreApplication::translate("UserInformation", "Late", nullptr));
        qliLost->setText(QCoreApplication::translate("UserInformation", "Lost", nullptr));
        qliResync->setText(QCoreApplication::translate("UserInformation", "Resync", nullptr));
        qliFromClient->setText(QCoreApplication::translate("UserInformation", "From Client", nullptr));
        qlFromGood->setText(QString());
        qlFromLate->setText(QString());
        qlFromLost->setText(QString());
        qlFromResync->setText(QString());
        qliToClient->setText(QCoreApplication::translate("UserInformation", "To Client", nullptr));
        qlToGood->setText(QString());
        qlToLate->setText(QString());
        qlToLost->setText(QString());
        qlToResync->setText(QString());
        qgbBandwidth->setTitle(QCoreApplication::translate("UserInformation", "Bandwidth", "GroupBox"));
        qliTime->setText(QCoreApplication::translate("UserInformation", "Connection time", nullptr));
        qlTime->setText(QString());
        qliBandwidth->setText(QCoreApplication::translate("UserInformation", "Bandwidth", "Label"));
