...
public:
    ...
    {
        PluginUpdater->setWindowTitle(QCoreApplication::translate("PluginUpdater", "PluginUpdater", nullptr));
        qlTitleText->setText(QCoreApplication::translate("PluginUpdater", "The following plugins can be updated.", nullptr));
        qcbSelectAll->setText(QCoreApplication::translate("PluginUpdater", "Select all", nullptr));
        qlPlugin->setText(QCoreApplication::translate("PluginUpdater", "Plugin", nullptr));
        qlURL->setText(QCoreApplication::translate("PluginUpdater", "Download-URL", nullptr));
        qlUpdateSelected->setText(QCoreApplication::translate("PluginUpdater", "Do you want to update the selected plugins?", nullptr));
    } // retranslateUi
