...
public:
    ...
    void retranslateUi(QDialog *TextMessage)
    {
        ...
        qcbTreeMessage->setToolTip(QCoreApplication::translate("TextMessage", "If checked the message is recursively sent to all subchannels", nullptr));
#endif // QT_CONFIG(tooltip)
        qcbTreeMessage->setText(QCoreApplication::translate("TextMessage", "Send recursively to subchannels", nullptr));
        (void)TextMessage;
    } // retranslateUi
