...
public:
    ...
    void setupUi(QDialog *ServerInformation)
    {
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, -201, 541, 726));
        ...
        formLayout_2->setItem(4, QFormLayout::SpanningRole, verticalSpacer_3);
        ...
        formLayout_2->setWidget(3, QFormLayout::FieldRole, connection_tcp_forwardSecrecy);
    ...
    {
        ServerInformation->setWindowTitle(QCoreApplication::translate("ServerInformation", "Server information", nullptr));
        qgbServerInformation->setTitle(QCoreApplication::translate("ServerInformation", "Server Information", nullptr));
        label->setText(QCoreApplication::translate("ServerInformation", "<b>Host:</b>", nullptr));
        label_2->setText(QCoreApplication::translate("ServerInformation", "<html><head/><body><p><span style=\" font-weight:600;\">Port:</span></p></body></html>", nullptr));
        label_3->setText(QCoreApplication::translate("ServerInformation", "<b>Users</b>:", nullptr));
        label_9->setText(QCoreApplication::translate("ServerInformation", "<html><head/><body><p><span style=\" font-weight:600;\">Protocol:</span></p></body></html>", nullptr));
        label_4->setText(QCoreApplication::translate("ServerInformation", "<html><head/><body><p><span style=\" font-weight:600;\">Release:</span></p></body></html>", nullptr));
        label_5->setText(QCoreApplication::translate("ServerInformation", "<html><head/><body><p><span style=\" font-weight:600;\">OS:</span></p></body></html>", nullptr));
        qgbAudioBandwidth->setTitle(QCoreApplication::translate("ServerInformation", "Audio", nullptr));
        label_31->setText(QCoreApplication::translate("ServerInformation", "<html><head/><body><p><span style=\" font-weight:600;\">Allowed:</span></p></body></html>", nullptr));
        label_32->setText(QCoreApplication::translate("ServerInformation", "<b>Current:</b>", nullptr));
        label_33->setText(QCoreApplication::translate("ServerInformation", "<b>Codec:</b>", nullptr));
        qgbConnectionDetails->setTitle(QCoreApplication::translate("ServerInformation", "Connection details", nullptr));
        connection_udp_encryptionLabel->setText(QCoreApplication::translate("ServerInformation", "<b>Encryption:</b>", nullptr));
        connection_udp_latencyLabel->setText(QCoreApplication::translate("ServerInformation", "<b>Avg. latency:</b>", nullptr));
        connection_udp_statisticsGroup->setTitle(QCoreApplication::translate("ServerInformation", "Statistics", nullptr));
        QTableWidgetItem *___qtablewidgetitem = connection_udp_statisticsTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QCoreApplication::translate("ServerInformation", "Outgoing", nullptr));
        QTableWidgetItem *___qtablewidgetitem1 = connection_udp_statisticsTable->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QCoreApplication::translate("ServerInformation", "Incoming", nullptr));
        QTableWidgetItem *___qtablewidgetitem2 = connection_udp_statisticsTable->verticalHeaderItem(0);
        ___qtablewidgetitem2->setText(QCoreApplication::translate("ServerInformation", "Good", nullptr));
        QTableWidgetItem *___qtablewidgetitem3 = connection_udp_statisticsTable->verticalHeaderItem(1);
        ___qtablewidgetitem3->setText(QCoreApplication::translate("ServerInformation", "Late", nullptr));
        QTableWidgetItem *___qtablewidgetitem4 = connection_udp_statisticsTable->verticalHeaderItem(2);
        ___qtablewidgetitem4->setText(QCoreApplication::translate("ServerInformation", "Lost", nullptr));
        QTableWidgetItem *___qtablewidgetitem5 = connection_udp_statisticsTable->verticalHeaderItem(3);
        ___qtablewidgetitem5->setText(QCoreApplication::translate("ServerInformation", "Resync", nullptr));
        connection_udp_infoMessage->setText(QCoreApplication::translate("ServerInformation", "Voice packets is currently sent over TCP.", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QCoreApplication::translate("ServerInformation", "UDP (Voice)", nullptr));
        label_11->setText(QCoreApplication::translate("ServerInformation", "<b>TLS version:</b>", nullptr));
        label_13->setText(QCoreApplication::translate("ServerInformation", "<b>Cipher suite:</b>", nullptr));
        label_15->setText(QCoreApplication::translate("ServerInformation", "<b>Avg. latency:</b>", nullptr));
#if QT_CONFIG(tooltip)
        label_6->setToolTip(QCoreApplication::translate("ServerInformation", "Whether the connection supports perfect forward secrecy (PFS).", nullptr));
#endif // QT_CONFIG(tooltip)
        label_6->setText(QCoreApplication::translate("ServerInformation", "<b>PFS:</b>", nullptr));
        connection_tcp_forwardSecrecy->setText(QCoreApplication::translate("ServerInformation", "<forward secrecy>", nullptr));
        tabWidget->setTabText(tabWidget->indexOf(tab), QCoreApplication::translate("ServerInformation", "TCP (Control)", nullptr));
        viewCertButton->setText(QCoreApplication::translate("ServerInformation", "&View certificate", nullptr));
        okButton->setText(QCoreApplication::translate("ServerInformation", "&Ok", nullptr));
    } // retranslateUi
