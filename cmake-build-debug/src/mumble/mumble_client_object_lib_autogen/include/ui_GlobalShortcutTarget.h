...
public:
    ...
    {
        GlobalShortcutTarget->setWindowTitle(QCoreApplication::translate("GlobalShortcutTarget", "Whisper Target", nullptr));
        qlTarget->setText(QCoreApplication::translate("GlobalShortcutTarget", "Shout/Whisper to:", nullptr));
        qgbSelection->setTitle(QCoreApplication::translate("GlobalShortcutTarget", "Current selection", nullptr));
        qlWhenShouting->setText(QCoreApplication::translate("GlobalShortcutTarget", "When shouting to channel:", nullptr));
#if QT_CONFIG(tooltip)
        qcbShoutLinks->setToolTip(QCoreApplication::translate("GlobalShortcutTarget", "The whisper will also be transmitted to linked channels.", nullptr));
#endif // QT_CONFIG(tooltip)
        qcbShoutLinks->setText(QCoreApplication::translate("GlobalShortcutTarget", "Shout to linked channels", nullptr));
#if QT_CONFIG(tooltip)
        qcbShoutSubchans->setToolTip(QCoreApplication::translate("GlobalShortcutTarget", "The whisper will also be sent to the subchannels of the channel target.", nullptr));
#endif // QT_CONFIG(tooltip)
        qcbShoutSubchans->setText(QCoreApplication::translate("GlobalShortcutTarget", "Shout to subchannels", nullptr));
        qgbUser->setTitle(QCoreApplication::translate("GlobalShortcutTarget", "List of users", nullptr));
        qpbAdd->setText(QCoreApplication::translate("GlobalShortcutTarget", "Add", nullptr));
        qpbRemove->setText(QCoreApplication::translate("GlobalShortcutTarget", "Remove", nullptr));
        qgbChannel->setTitle(QCoreApplication::translate("GlobalShortcutTarget", "Channel Target", nullptr));
        qlGroup->setText(QCoreApplication::translate("GlobalShortcutTarget", "Restrict to Group", nullptr));
#if QT_CONFIG(tooltip)
        qleGroup->setToolTip(QCoreApplication::translate("GlobalShortcutTarget", "If specified, only members of this group will receive the whisper.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(tooltip)
        qcbLinks->setToolTip(QCoreApplication::translate("GlobalShortcutTarget", "The whisper will also be transmitted to linked channels.", nullptr));
#endif // QT_CONFIG(tooltip)
        qcbLinks->setText(QCoreApplication::translate("GlobalShortcutTarget", "Shout to Linked channels", nullptr));
#if QT_CONFIG(tooltip)
        qcbChildren->setToolTip(QCoreApplication::translate("GlobalShortcutTarget", "The whisper will also be sent to the subchannels of the channel target.", nullptr));
#endif // QT_CONFIG(tooltip)
        qcbChildren->setText(QCoreApplication::translate("GlobalShortcutTarget", "Shout to subchannels", nullptr));
        qgbModifiers->setTitle(QCoreApplication::translate("GlobalShortcutTarget", "Modifiers", nullptr));
#if QT_CONFIG(tooltip)
        qcbForceCenter->setToolTip(QCoreApplication::translate("GlobalShortcutTarget", "Do not send positional audio information when using this whisper shortcut.", nullptr));
#endif // QT_CONFIG(tooltip)
        qcbForceCenter->setText(QCoreApplication::translate("GlobalShortcutTarget", "Ignore positional audio", nullptr));
        qcbTarget->setItemText(0, QCoreApplication::translate("GlobalShortcutTarget", "Current selection", nullptr));
        qcbTarget->setItemText(1, QCoreApplication::translate("GlobalShortcutTarget", "List of users", nullptr));
        qcbTarget->setItemText(2, QCoreApplication::translate("GlobalShortcutTarget", "Channel", nullptr));
