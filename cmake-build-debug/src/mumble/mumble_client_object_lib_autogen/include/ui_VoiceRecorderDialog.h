...
public:
    ...
    {
        VoiceRecorderDialog->setWindowTitle(QCoreApplication::translate("VoiceRecorderDialog", "Recorder", nullptr));
        qgbControl->setTitle(QCoreApplication::translate("VoiceRecorderDialog", "Control", nullptr));
        qlTime->setText(QCoreApplication::translate("VoiceRecorderDialog", "00:00:00", nullptr));
        qpbStart->setText(QCoreApplication::translate("VoiceRecorderDialog", "&Start", nullptr));
        qpbStop->setText(QCoreApplication::translate("VoiceRecorderDialog", "S&top", nullptr));
        qgbMode->setTitle(QCoreApplication::translate("VoiceRecorderDialog", "Mode", nullptr));
        qrbDownmix->setText(QCoreApplication::translate("VoiceRecorderDialog", "Downmix", nullptr));
        qrbMultichannel->setText(QCoreApplication::translate("VoiceRecorderDialog", "Multichannel", nullptr));
        qgbOutput->setTitle(QCoreApplication::translate("VoiceRecorderDialog", "Output", nullptr));
        qlOutputFormat->setText(QCoreApplication::translate("VoiceRecorderDialog", "Output format", nullptr));
        qlTargetDirectory->setText(QCoreApplication::translate("VoiceRecorderDialog", "Target directory", nullptr));
        qlFilename->setText(QCoreApplication::translate("VoiceRecorderDialog", "Filename", nullptr));
        qpbTargetDirectoryBrowse->setText(QCoreApplication::translate("VoiceRecorderDialog", "&Browse...", nullptr));
    } // retranslateUi
