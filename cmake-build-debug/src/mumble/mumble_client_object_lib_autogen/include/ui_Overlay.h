...
public:
    ...
    {
        qgbOptions->setTitle(QCoreApplication::translate("OverlayConfig", "Options", nullptr));
#if QT_CONFIG(tooltip)
        qcbEnable->setToolTip(QCoreApplication::translate("OverlayConfig", "Enable overlay.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        qcbEnable->setWhatsThis(QCoreApplication::translate("OverlayConfig", "This sets whether the overlay is enabled or not. This setting is only checked when applications are started, so make sure Mumble is running and this option is on before you start the application.<br />Please note that if you start Mumble after starting the application, or if you disable the overlay while the application is running, there is no safe way to restart the overlay without also restarting the application.", nullptr));
#endif // QT_CONFIG(whatsthis)
        qcbEnable->setText(QCoreApplication::translate("OverlayConfig", "Enable Overlay", nullptr));
#if QT_CONFIG(tooltip)
        qpbLoadPreset->setToolTip(QCoreApplication::translate("OverlayConfig", "Load an overlay preset from file", nullptr));
#endif // QT_CONFIG(tooltip)
        qpbLoadPreset->setText(QCoreApplication::translate("OverlayConfig", "Load\342\200\246", nullptr));
#if QT_CONFIG(tooltip)
        qpbSavePreset->setToolTip(QCoreApplication::translate("OverlayConfig", "Save your overlay settings to file", nullptr));
#endif // QT_CONFIG(tooltip)
        qpbSavePreset->setText(QCoreApplication::translate("OverlayConfig", "Save\342\200\246", nullptr));
        qpbUninstall->setText(QCoreApplication::translate("OverlayConfig", "Uninstall Overlay", nullptr));
        qgpFps->setTitle(QCoreApplication::translate("OverlayConfig", "FPS and Clock Display", nullptr));
#if QT_CONFIG(tooltip)
        qcbShowFps->setToolTip(QCoreApplication::translate("OverlayConfig", "Display a frame counter in the overlay", nullptr));
#endif // QT_CONFIG(tooltip)
        qcbShowFps->setText(QCoreApplication::translate("OverlayConfig", "Show FPS counter", nullptr));
#if QT_CONFIG(tooltip)
        qcbShowTime->setToolTip(QCoreApplication::translate("OverlayConfig", "Display a clock in the overlay showing the current local time (system time).", nullptr));
#endif // QT_CONFIG(tooltip)
        qcbShowTime->setText(QCoreApplication::translate("OverlayConfig", "Show Clock", nullptr));
#if QT_CONFIG(tooltip)
        qpbFpsFont->setToolTip(QCoreApplication::translate("OverlayConfig", "Set the overlay font.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        qpbFpsFont->setWhatsThis(QString());
#endif // QT_CONFIG(whatsthis)
        qpbFpsFont->setText(QCoreApplication::translate("OverlayConfig", "Font", nullptr));
#if QT_CONFIG(tooltip)
        qpbFpsColor->setToolTip(QCoreApplication::translate("OverlayConfig", "Set the overlay text color.", nullptr));
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        qpbFpsColor->setWhatsThis(QString());
#endif // QT_CONFIG(whatsthis)
        qpbFpsColor->setText(QCoreApplication::translate("OverlayConfig", "Color", nullptr));
        qtwSetup->setTabText(qtwSetup->indexOf(qwLayoutTab), QCoreApplication::translate("OverlayConfig", "Layout", nullptr));
        label->setText(QCoreApplication::translate("OverlayConfig", "Overlay Exception Mode", nullptr));
        qlLaunchersLabel->setText(QCoreApplication::translate("OverlayConfig", "Allowed launchers", nullptr));
        qpbLaunchersAdd->setText(QCoreApplication::translate("OverlayConfig", "Add", nullptr));
        qpbLaunchersRemove->setText(QCoreApplication::translate("OverlayConfig", "Remove", nullptr));
        qlWhitelistLabel->setText(QCoreApplication::translate("OverlayConfig", "Allowed programs", nullptr));
        qpbWhitelistAdd->setText(QCoreApplication::translate("OverlayConfig", "Add", nullptr));
        qpbWhitelistRemove->setText(QCoreApplication::translate("OverlayConfig", "Remove", nullptr));
        qlPathsLabel->setText(QCoreApplication::translate("OverlayConfig", "Allowed paths", nullptr));
        qpbPathsAdd->setText(QCoreApplication::translate("OverlayConfig", "Add", nullptr));
        qpbPathsRemove->setText(QCoreApplication::translate("OverlayConfig", "Remove", nullptr));
        qlvBlacklistLabel->setText(QCoreApplication::translate("OverlayConfig", "Blacklisted programs", nullptr));
        qpbBlacklistAdd->setText(QCoreApplication::translate("OverlayConfig", "Add", nullptr));
        qpbBlacklistRemove->setText(QCoreApplication::translate("OverlayConfig", "Remove", nullptr));
        qtwSetup->setTabText(qtwSetup->indexOf(qwExceptions), QCoreApplication::translate("OverlayConfig", "Overlay Exceptions", nullptr));
        groupBox->setTitle(QCoreApplication::translate("OverlayConfig", "Overlay Installation", nullptr));
        qlInstallIcon->setText(QString());
        qlInstallText->setText(QCoreApplication::translate("OverlayConfig", "Mumble has detected that you do not have the Mumble Overlay installed.\n"
"\n"
"Click the button below to install the overlay.", nullptr));
        qpbInstall->setText(QCoreApplication::translate("OverlayConfig", "Install Mumble Overlay", nullptr));
        groupBox_2->setTitle(QCoreApplication::translate("OverlayConfig", "Overlay Upgrade", nullptr));
        qlUpgradeIcon->setText(QString());
        qlUpgradeText->setText(QCoreApplication::translate("OverlayConfig", "Mumble has detected an old version of the overlay support files installed on your computer.\n"
"\n"
"To upgrade these files to their latest versions, click the button below.", nullptr));
        qpbUpgrade->setText(QCoreApplication::translate("OverlayConfig", "Upgrade Mumble Overlay", nullptr));
        (void)OverlayConfig;
    } // retranslateUi
